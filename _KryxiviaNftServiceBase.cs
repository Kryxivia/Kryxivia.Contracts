...
{
    public partial class _KryxiviaNftServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, KryxiviaNftDeployment kryxiviaNftDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<KryxiviaNftDeployment>().SendRequestAndWaitForReceiptAsync(kryxiviaNftDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, KryxiviaNftDeployment kryxiviaNftDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<KryxiviaNftDeployment>().SendRequestAsync(kryxiviaNftDeployment);
        }

        public static async Task<_KryxiviaNftServiceBase> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, KryxiviaNftDeployment kryxiviaNftDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, kryxiviaNftDeployment, cancellationTokenSource);
            return new _KryxiviaNftServiceBase(web3, receipt.ContractAddress);
        }
        ...
        public _KryxiviaNftServiceBase(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> MintRequestAsync(string to, string ipfsHash)
        {
            var mintFunction = new MintFunction();
            mintFunction.To = to;
            mintFunction.IpfsHash = ipfsHash;

            return ContractHandler.SendRequestAsync(mintFunction);
        }

        public Task<TransactionReceipt> MintRequestAndWaitForReceiptAsync(string to, string ipfsHash, CancellationTokenSource cancellationToken = null)
        {
            var mintFunction = new MintFunction();
            mintFunction.To = to;
            mintFunction.IpfsHash = ipfsHash;
